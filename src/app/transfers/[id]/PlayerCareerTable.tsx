        ...
        <table className="w-full text-sm min-w-[560px]">
          <thead className="bg-neutral-50 dark:bg-white/[0.03] text-xs text-neutral-500">
            <tr>
              ...
              <th className="text-left px-2 py-2 font-medium">대회</th>
              <th className="px-2 py-2 font-medium text-center">평점</th>
              <th className="px-2 py-2 font-medium text-right">출전</th>
              <th className="px-2 py-2 font-medium text-right">골</th>
              <th className="px-2 py-2 font-medium text-right">도움</th>
              <th className="px-3 py-2 font-medium text-right">경고/퇴장</th>
            </tr>
          </thead>
          ...
          <tfoot className="bg-neutral-50 dark:bg-white/[0.03] font-semibold border-t border-black/10 dark:border-white/10">
            <tr>
              <td className="px-3 py-2.5 text-xs" colSpan={3}>합계</td>
              <td className="px-2 py-2.5 text-center">
                {g.total.rating != null ? (
