// 시즌별 팀 요약 표 — 시즌당 소속팀별 합산(출전·골·도움·평점). 같은 시즌 복수 팀(임대 등)은
// 들여쓰기(↳) 하위 행으로 (buildup 벤치마크). 데이터는 경력(career-data) 클럽 대회 집계.
  ...
  return (
    <section className="rounded-xl bg-white ring-1 ring-black/5 overflow-hidden dark:bg-white/[0.04] dark:ring-white/10">
      <div className="px-4 pt-3.5 pb-2">
        <h2 className="text-lg font-semibold">시즌별 팀 요약</h2>
        <p className="text-xs text-neutral-400">클럽 대회 합산 · 같은 시즌 복수 팀은 하위 행(임대 등)</p>
      </div>
      <table className="w-full text-sm">
        <thead>
          <tr className="text-[11px] text-neutral-400 border-b border-black/5 dark:border-white/5">
            <th className="px-3 py-1.5 text-left font-semibold">시즌</th>
            <th className="px-3 py-1.5 text-left font-semibold">팀</th>
            <th className="px-2 py-1.5 text-right font-semibold">출전</th>
            <th className="px-2 py-1.5 text-right font-semibold text-rose-400">골</th>
            <th className="px-2 py-1.5 text-right font-semibold text-blue-400">도움</th>
            <th className="px-3 py-1.5 text-right font-semibold">평점</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr className="bg-neutral-50 dark:bg-white/[0.03]">
            <td className="px-3 py-2 text-xs font-bold" colSpan={2}>총합 / 평균</td>
