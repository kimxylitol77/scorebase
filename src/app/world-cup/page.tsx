...
// 대회 종료(7/19 결승 스페인 1-0 아르헨티나·연장) — "대비/확률" 프레임에서 결과·기록 아카이브로 전환.
// 빙 검색어 "월드컵 결과"·"월드컵 순위"(종료 후에도 수요 잔존) 정밀 매칭.
export const metadata: Metadata = {
  title: "2026 월드컵 결과 — 스페인 우승 · 전 경기 스코어·순위·기록",
  description:
    "2026 북중미 월드컵(6/11~7/19) 최종 결과 — 우승 스페인(결승 아르헨티나전 연장 1-0), 조별리그 A~L 순위부터 토너먼트 전 경기 스코어, 선수 랭킹·xG 기록까지 48개국 데이터 아카이브.",
  keywords: ["2026 월드컵", "월드컵 결과", "월드컵 우승", "스페인 우승", "월드컵 결승", "월드컵 순위", "월드컵 경기결과", "월드컵 조별리그", "월드컵 기록", "스코어베이스"],
  alternates: { canonical: "/world-cup" },
  openGraph: {
    title: "2026 월드컵 결과 — 스페인 우승 · 전 경기 기록",
    description: "북중미 월드컵 최종 아카이브 — 결승 스페인 1-0 아르헨티나, 조별 순위·대진표·전 경기 스코어.",
    url: `${SITE_URL}/world-cup`,
    images: ogPageImage({ title: "2026 월드컵 결과", subtitle: "스페인 우승 — 전 경기 스코어·순위·기록 아카이브", tag: "WORLD CUP" }),
  },
};
