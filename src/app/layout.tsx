      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var host=(location.hostname||'').toLowerCase();var sb=host.indexOf('스코어보드')>=0||host.indexOf('xn--hy1bm7m1yevrd8pq')>=0;var sp=host.indexOf('sportspredictions')>=0;var c=document.cookie.match(/(?:^|; )theme=([^;]+)/);var t=c?c[1]:localStorage.getItem('theme');var wantLight=!sp&&(sb||t==='light'||(!t&&window.matchMedia&&window.matchMedia('(prefers-color-scheme: light)').matches));if(!c&&!sb&&!sp){document.cookie='theme='+(wantLight?'light':'dark')+'; path=/; max-age=31536000; SameSite=Lax';}var h=document.documentElement;if(wantLight){h.classList.remove('dark');h.style.backgroundColor='#ffffff';h.style.color='#0a0a0a';h.style.colorScheme='light';}else{h.classList.add('dark');h.style.backgroundColor='#0a0a0a';h.style.color='#ededed';h.style.colorScheme='dark';}}catch(e){}})();`,
          }}
        />
