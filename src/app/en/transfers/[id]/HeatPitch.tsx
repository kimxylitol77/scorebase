// 활동 히트맵 피치 (영어판). scripts/en-mirror 로 자동 생성.
"use client";
...
export default function HeatPitch({ points, ariaLabel = "Activity heatmap" }: { points: HeatPoint[]; ariaLabel?: string }) {
  ...
  return (
    <div className="relative overflow-hidden rounded-lg bg-[#173d22] ring-1 ring-black/20">
      <svg viewBox="0 0 680 440" role="img" aria-label={`${ariaLabel} (attacking right)`} className="block h-auto w-full">
        <defs>
