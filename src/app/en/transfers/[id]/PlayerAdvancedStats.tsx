// 시즌 성적 상세 (영어판). scripts/en-mirror 로 자동 생성.
"use client";
...
const CATEGORIES: { title: string; rows: Row[] }[] = [
  {
    title: "Shooting",
    rows: [
      { label: "Goals", key: "goals", kind: "count" },
      { label: "Shots", key: "shots", kind: "count" },
      { label: "On target", key: "sot", kind: "count" },
      { label: "Shot accuracy", key: "sot", pctKey: "shotAcc", kind: "pct", ratio: ["sot", "shots"] },
    ],
  },
  {
    title: "Passing & creation",
    rows: [
      { label: "Assists", key: "assists", kind: "count" },
      { label: "Chances created", key: "keyPasses", kind: "count" },
      { label: "Pass accuracy", key: "passAcc", kind: "pct" },
    ],
  },
  {
    title: "Dribbles & duels",
    rows: [
      { label: "Dribbles completed", key: "dribbles", kind: "count" },
      { label: "Dribble success", key: "dribbles", pctKey: "dribbleRate", kind: "pct", ratio: ["dribbles", "dribbleAtt"] },
      { label: "Duels won", key: "duelsWon", kind: "count" },
      { label: "Duel success", key: "duelsWon", pctKey: "duelRate", kind: "pct", ratio: ["duelsWon", "duelsTotal"] },
    ],
  },
  {
    title: "Defending",
    rows: [
      { label: "Tackles", key: "tackles", kind: "count" },
      { label: "Interceptions", key: "interceptions", kind: "count" },
      { label: "Blocks", key: "blocks", kind: "count" },
      { label: "Dribbled past", key: "dribbledPast", kind: "count", invert: true },
    ],
  },
  {
    title: "Fouls",
    rows: [
      { label: "Fouls won", key: "foulsDrawn", kind: "count" },
      { label: "Fouls committed", key: "foulsCommitted", kind: "count", invert: true },
      { label: "Yellow cards", key: "yellow", kind: "count", invert: true },
      { label: "Red cards", key: "red", kind: "count", invert: true },
    ],
  },
];
    ...
    <section className="rounded-2xl bg-white ring-1 ring-black/5 shadow-[0_24px_70px_-30px_rgba(15,23,30,0.18)] dark:bg-white/[0.04] dark:ring-white/10 dark:shadow-none overflow-hidden">
      ...
      >
        <span className="text-base font-bold tracking-tight">
          ...
          <span className="ml-2 text-xs font-medium text-neutral-400">Ranks are percentiles against the same position</span>
        </span>
        ...
        <div className="px-4 sm:px-5 pb-5">
          ...
          <div className="flex justify-end mb-4">
            <div className="inline-flex rounded-full bg-neutral-100 dark:bg-white/[0.06] p-0.5 text-xs font-semibold">
              {[["Total", false], ["Per 90", true]].map(([label, v]) => (
                <button
                  key={String(label)}
