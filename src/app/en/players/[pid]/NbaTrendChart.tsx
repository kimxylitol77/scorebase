// NbaTrendChart (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
"use client";
  ...
  return (
    <section className="rounded-2xl bg-white ring-1 ring-black/5 overflow-hidden shadow-[0_24px_70px_-30px_rgba(15,23,30,0.18)] dark:bg-white/[0.04] dark:ring-white/10 dark:shadow-none">
      <div className="px-5 pt-4 pb-1">
        <h2 className="text-base font-bold tracking-tight">PTS · REB · AST by season</h2>
        <p className="text-xs text-neutral-400">Per game — how the numbers rise or fall across seasons</p>
      </div>
