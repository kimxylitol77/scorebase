  ...
  if (url) {
    ...
    return (
      <img
        src={url}
        alt=""
        className="w-12 h-12 sm:w-14 sm:h-14 object-contain mx-auto mb-1 bg-white rounded-lg p-1"
        loading="lazy"
      />
    );
  }
...
export default function MlbLiveDetail({
  ...
  return (
    <div className="space-y-4">
      ...
      {/* PBP / 팀 통계 / WPA / 라인업 / 박스스코어 / 라이브 배당 — 모두 page.tsx 의
          통합 8탭 카드 (MlbBoxscoreTabs) 로 이동. 여기서는 점수보드 + 다이아몬드 만 */}
    </div>
  );
}
