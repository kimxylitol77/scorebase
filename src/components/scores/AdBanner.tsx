// /scores 상단 배너 — 유료 광고(AdBanner DB, enabled)가 있으면 그 이미지를,
// 없으면 자사 이적시장 홍보 배너(house ad)를 얇은 리더보드로 표시한다. 폭 100% 반응형.
        ...
        <div className="relative flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            <p className="text-sm sm:text-base font-bold text-white leading-tight truncate">
              여름 <span className="text-rose-400">이적시장</span> 총정리
            </p>
