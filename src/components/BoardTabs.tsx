// 커뮤니티 보드 통합 탭 — 스포츠 분석·자유게시판·해외 브리핑·블로그·공지를 한 탭 바로 묶는다.
// analysis/blog/notices 세 페이지가 공유해 어느 글에서든 나머지 보드로 넘나든다(헤더 메뉴 1개로 통일).
...
const TABS = [
  ...
  { key: "briefing", label: "해외 브리핑", href: "/analysis?board=briefing" },
