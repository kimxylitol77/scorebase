// 선수 시장가치·연봉·상금 페이지 종목별 탭 — /transfers · /salaries/{kbo,mlb,nba,nhl,golf,tennis,f1} 공유 네비
...
const TABS = [
  ...
  { href: "/salaries/golf", label: "골프" },
  { href: "/salaries/tennis", label: "테니스" },
  { href: "/salaries/f1", label: "F1" },
] as const;
