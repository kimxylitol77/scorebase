// components__ArticleCard (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
...
> = {
  PREVIEW: { label: "Preview", cls: BADGE_CLS },
  RECAP: { label: "Report", cls: BADGE_CLS },
  ANALYSIS: { label: "Analysis", icon: "📊", cls: BADGE_CLS },
};
  ...
  const matchup =
    home && away
      ? {
          home,
          away,
          homeKo: toEnglishTeamName(home.name),
          awayKo: toEnglishTeamName(away.name),
        }
      : null;
