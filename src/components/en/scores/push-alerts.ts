// scores__push-alerts (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
"use client";
...
export const PUSH_KIND_LABEL: Record<PushKind, string> = { KICKOFF: "15 minutes before kick-off", LINEUP: "Starting line-ups announced", FINAL: "Full-time result" };
