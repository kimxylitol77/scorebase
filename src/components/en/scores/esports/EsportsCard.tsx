// scores__esports__EsportsCard (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
        ...
        >
          <div className="flex items-center justify-between text-[11px]">
            <span className="font-bold text-neutral-300">
              BO{bestOf}
              {isLive && currentGame && (
                <span className="text-neutral-500"> · {currentGame}Game</span>
              )}
            </span>
            <span className="text-[10px] text-neutral-500">{need} to win</span>
          </div>
          <SeriesRow
