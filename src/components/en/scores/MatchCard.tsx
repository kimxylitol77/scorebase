// scores__MatchCard (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
...
function MmaTaleOfTape({ mma }: { mma: NonNullable<MatchCardProps["mma"]> }) {
  const rows = (
    [
      ["Height", mma.home.height, mma.away.height],
      ["Weight", mma.home.weight, mma.away.weight],
      ["Reach", mma.home.reach, mma.away.reach],
      ["Stance", mma.home.stance, mma.away.stance],
...
export default function MatchCard(props: MatchCardProps) {
  ...
  const statusNode = isPostponed ? (
    <span className="status-badge finished">PP</span>
  ) : isLive ? (
