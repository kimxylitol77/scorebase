// ConsensusGate (영어판). scripts/en-mirror 로 자동 생성.
"use client";
    ...
    <div className="relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="mx-4 max-w-sm rounded-2xl bg-white/95 p-5 text-center shadow-xl ring-1 ring-zinc-200 backdrop-blur dark:bg-zinc-900/95 dark:ring-white/15">
          ...
          >
            Sign in with Google to see everything
          </a>
          {checked && (
            <p className="mt-2 text-[11px] text-zinc-400 dark:text-white/35">
              Already a member? <a href="/login?from=%2Fpredictions%2Fscorecard" className="underline underline-offset-2">Sign in</a>
            </p>
          )}
        </div>
      </div>
