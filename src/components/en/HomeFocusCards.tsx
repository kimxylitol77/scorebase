// HomeFocusCards (영어판). scripts/en-mirror 로 자동 생성 — 직접 수정하지 말 것.
...
const CARDS: Card[] = [
  {
    href: "/predictions",
    title: "Season prediction dashboard",
    description: "Title and relegation probabilities from Elo and Monte Carlo simulation",
  },
  {
    href: "/scores",
    title: "Scorebase live scores",
    description: "KBO, NPB, MLB, Premier League, NBA and NHL live push (2–3 seconds)",
    highlight: true,
  },
  {
    href: "/previews",
    title: "Match previews",
    description: "AI-generated insight for every fixture",
  },
  {
    href: "/injuries",
    title: "Injury lists",
    description: "10 leagues, updated daily",
  },
];
