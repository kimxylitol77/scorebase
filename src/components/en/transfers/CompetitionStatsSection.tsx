// 대회별 스탯 (영어판). scripts/en-mirror 로 자동 생성.
...
const COMP_KO: Record<string, string> = {
  ...
  "World Cup": "World Cup",
  "UEFA World Cup Qualifiers": "World Cup qualifying (UEFA)",
  "World Cup - Qualification Europe": "World Cup qualifying (UEFA)",
  "World Cup - Qualification South America": "World Cup qualifying (CONMEBOL)",
  "World Cup - Qualification Africa": "World Cup qualifying (CAF)",
  "World Cup - Qualification Asia": "World Cup qualifying (AFC)",
  "World Cup - Qualification CONCACAF": "World Cup qualifying (CONCACAF)",
  ...
  return (
    <section className="rounded-xl bg-white ring-1 ring-black/5 overflow-hidden dark:bg-white/[0.04] dark:ring-white/10">
      <div className="px-4 pt-3 pb-2 flex items-baseline justify-between">
        <h2 className="text-sm font-bold flex items-center gap-1.5"><Trophy className="h-4 w-4 text-rose-500" aria-hidden /> This season by competition</h2>
        <span className="text-[11px] text-neutral-500">{seasonLabel} season · competitions {rows.length}</span>
      </div>
