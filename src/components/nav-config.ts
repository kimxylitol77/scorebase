...
export const SPORT_CATEGORIES: NavCategory[] = [
  {
    label: "축구",
    href: "/previews?sport=SOCCER",
    items: [
      { href: "/previews?sport=SOCCER", label: "AI 프리뷰·분석", desc: "경기 전 예측·핵심 지표" },
  ...
  {
    label: "농구",
    href: "/previews?sport=BASKETBALL",
    items: [
...
// 커뮤니티 — 콘텐츠·회원·랭킹 (+ 부상자 명단: 종목 무관 공통이라 여기로)
