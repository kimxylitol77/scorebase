  ...
  return (
    ...
    >
      ...
      >
        <Link
          href={href}
          className={`inline-flex items-center pl-2 xl:pl-3 py-1.5 ${hasMenu ? "pr-1" : "pr-2 xl:pr-3"} rounded-full ${active ? "font-semibold" : "font-medium"}`}
        ...
        {hasMenu && (
          <button
            ...
            onClick={() => setOpen((v) => !v)}
            className="inline-flex items-center justify-center pl-0.5 pr-1.5 xl:pr-2 py-1.5 rounded-full focus-visible:outline-2 focus-visible:outline-offset-1 focus-visible:outline-blue-500"
          >
            <svg
