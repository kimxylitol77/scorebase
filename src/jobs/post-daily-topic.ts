...
const LEAGUE_PRIORITY = ["WORLD_CUP", "KBO", "EPL", "UCL", "UEL", "UECL", "UEFA_NL", "CLUB_WORLD_CUP", "LALIGA", "MLB", "NPB", "K_LEAGUE_1"];
const LEAGUE_KO: Record<string, string> = {
  WORLD_CUP: "월드컵", KBO: "KBO", EPL: "EPL", UCL: "UCL", UEL: "유로파리그", UECL: "유로파 컨퍼런스리그", UEFA_NL: "UEFA 네이션스리그", CLUB_WORLD_CUP: "클럽 월드컵",
  LALIGA: "라리가", MLB: "MLB", NPB: "NPB", K_LEAGUE_1: "K리그1",
};
const SOCCER = new Set(["WORLD_CUP", "EPL", "UCL", "UEL", "UECL", "UEFA_NL", "CLUB_WORLD_CUP", "LALIGA", "K_LEAGUE_1"]);
