...
export const ALL_LEAGUES = [
  ...
  "NBA", "WNBA", "KBL", "WKBL", "NBA_SL", "ASIAN_GAMES_BK", "ASIAN_GAMES_BK_W", "NHL", "IIHF_WC", "LOL", "LCK_CL", "LPL", "LEC", "LCS", "EWC", "UFC",
...
export const SPORTS: SportMeta[] = [
  ...
  },
  {
    ...
    label: "농구",
    emoji: "🏀",
    leagues: ["NBA", "WNBA", "KBL", "WKBL", "NBA_SL", "ASIAN_GAMES_BK", "ASIAN_GAMES_BK_W"],
  },
  {
    code: "volleyball",
    label: "배구",
...
export const LEAGUE_DISPLAY: Record<string, string> = {
  ...
  ASIAN_GAMES_BK_W: "아시안게임 여자농구", // 2026-09-21 — 베트맨 여자농구 52행이 이을 경기가 없던 것. ts comp vl7oqd4t30q510j, 표시 전용
  NHL: "NHL",
  IIHF_WC: "세계선수권",
  AIHL: "호주 아이스하키",
  NZIHL: "뉴질랜드 아이스하키",
...
export const LEAGUE_ORDER: Record<string, number> = {
  ...
  YKKOSLIIGA: 15.934, // VEIKKAUSLIIGA(15.932)와 YKKONEN(15.936) 사이 — 진짜 2부
  URVALSDEILD: 15.933,
  NORWAY_1L: 15.934,
  SUPERETTAN: 15.935,
  YKKONEN: 15.936,
