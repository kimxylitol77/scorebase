...
export const collectors: Record<League, MatchCollector> = {
  ...
  NORWAY_2D_G1: buildApiFootballCollector("NORWAY_2D_G1"),
  NORWAY_2D_G2: buildApiFootballCollector("NORWAY_2D_G2"),
  KAKKONEN_A: buildApiFootballCollector("KAKKONEN_A"),
  KAKKONEN_B: buildApiFootballCollector("KAKKONEN_B"),
  KAKKONEN_C: buildApiFootballCollector("KAKKONEN_C"),
  ROMANIA_L2: buildApiFootballCollector("ROMANIA_L2"),
  CHINA_3: buildApiFootballCollector("CHINA_3"),
  COSTA_RICA_PD: buildApiFootballCollector("COSTA_RICA_PD"),
  GUATEMALA_LN: buildApiFootballCollector("GUATEMALA_LN"),
  HONDURAS_LN: buildApiFootballCollector("HONDURAS_LN"),
  UZBEKISTAN_SL: buildApiFootballCollector("UZBEKISTAN_SL"),
  WALES_PL: buildApiFootballCollector("WALES_PL"),
  MONTENEGRO_1L: buildApiFootballCollector("MONTENEGRO_1L"),
