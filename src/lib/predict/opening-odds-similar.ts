...
//
// 축구는 제외 — 빅5 표본이 리그당 8~20건뿐이라 MIN_SAMPLE 을 넘지 못한다
// (지난 시즌 막바지 사흘만 캡처 + 이후 시즌 오프). 8월 개막 후 재검토할 것.

import { prisma } from "@/lib/db";

/**
 * 오프닝 배당 유사경기 카드를 지원하는 리그 — 표본이 충분한 야구 3리그.
 * 축구를 추가할 때는 무승부가 있는 3-way 라 카드의 2분할 표시도 함께 손봐야 한다.
 */
