...
- **과거 시즌 인덱스 함정 (첫 백필 실패 원인)**: 팀별 POST 에 ddlSeason 만 실어 보내면 시즌이
  적용되지 않고 리그 규정 상위 30 페이지가 조용히 돌아옴(2025 가 22/30명으로 잘렸었다).
  시즌 변경 이벤트 POST → 응답 viewstate 로 팀 변경 POST 의 2단계 체인이 정답.
  추가로 ucPager LinkButton 2페이지 순회(30행 절단 방지)도 넣음.
- 백필 실측(2026-08-09): 시즌당 5~7분, 총 143,174행 — 2021:25,300 / 22:24,567 / 23:25,090 /
  24:25,131 / 25:25,532 / 26:17,554(진행 중). 시즌당 선수 540~589명.
- 정합 대조: 이정후 2022 = 142경기·23HR·113RBI·193H (공식 기록 일치).
