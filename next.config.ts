...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // sportspredictions.live — canonical 은 apex. www 는 308 로 합친다 (docs/sportspredictions).
      {
        source: "/:path*",
        has: [{ type: "host", value: "www.sportspredictions.live" }],
        destination: "https://sportspredictions.live/:path*",
        permanent: true,
      },
