    ...
    >
      ...
      <div>
        ...
        <input
          ...
          autoFocus
          className="w-full px-3 py-2.5 rounded-md border border-neutral-300 dark:border-neutral-700 bg-white dark:bg-neutral-950 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
      </div>
