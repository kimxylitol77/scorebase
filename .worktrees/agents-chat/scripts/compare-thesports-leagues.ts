...
const LEAGUE_EN_KEYWORDS: Record<string, RegExp> = {
  ...
  CHAMPIONSHIP: /^English Football League Championship$/i,
  ...
  A_LEAGUE: /^Australia A-League$/i,
  EREDIVISIE: /^Netherlands Eredivisie$/i,
  PRIMEIRA_LIGA: /^Portuguese Primera Liga$/i,
  ...
  SWISS_SL: /^Switzerland Super League$/i,
  CHALLENGE_LEAGUE: /^Switzerland Challenge League$/i,
  ...
  SLOVAKIA_SL: /^Slovak Nike liga$/i,
  SLOVENIA_SNL: /^Slovenia 1\.Liga$/i,
  ...
  BRASILEIRAO: /^Brazilian Serie A$/i,
  ...
  VIETNAM_VL1: /^Vietnam National Champion League$/i,
  INDONESIA_L1: /^Indonesian Super League$/i,
  SINGAPORE_PL: /\bSingapore Premier League\b/i,
  UAE_PL: /^United Arab Emirates Adnoc Pro-League$/i,
  QATAR_SL: /^Qatar Stars League$/i,
  MOROCCO_BP: /\bBotola Pro\b/i,
  SOUTHAFRICA_PSL: /^South Africa Premier Soccer League$/i,
