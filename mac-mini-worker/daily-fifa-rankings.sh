...
# 여기서는 ① 랭킹 json 6개만 add ② 실패 시 push 안 함 ③ 변경 없으면 commit 생략.
set -e
set -o pipefail
cd ~/dev/scorebase
...
FILES="src/lib/sports/fifa-rankings.json src/lib/sports/fifa-rankings-meta.json src/lib/sports/fifa-rankings-women.json src/lib/sports/fifa-rankings-women-meta.json data/club-rankings.json data/club-rankings-meta.json"
