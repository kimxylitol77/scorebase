...
const FOCUS_ROTATION = [
  ...
  "AI 픽·예측·시뮬 — [축구] Forebet, WinDrawWin, PredictZ, Infogol(xG) / [NBA·MLB] Dimers(ML 전경기 승률), Rithmm(모델 빌더), OddsTrader(정확도 별점 공개), The Stat Wire(ELO+선발 파워랭킹), PropsBot.AI(MLB prop 검증 ROI), Baseball Predict, Covers(MLB 컨센서스)",   // 3 수
...
- 월드컵 관련 기능·콘텐츠·아이디어는 전부 제외 — 관찰·앞선 점·아이디어 어디에도 넣지 말 것.
