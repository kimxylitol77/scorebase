#!/usr/bin/env bash
# install.sh — Mac mini launchd 등록 (7 봇 모두)
...
echo ""
echo "▶ 로그 위치 — tail -f /tmp/{match-narrator,endpoint-monitor,data-quality,api-quota,preview-coverage,live-scores-watcher,route-guardian}.log"
